<?
	...
	define("EZSQL_DB_NAME", "trustworthy");		// <-- mysql db pname
	define("EZSQL_DB_HOST", "localhost");	// <-- mysql server host
	

	/*define("EZSQL_DB_USER", "website_upgrade");			// <-- mysql db user
	define("EZSQL_DB_PASSWORD", "Website123");		// <-- mysql db password
	define("EZSQL_DB_NAME", "website_upgrade");		// <-- mysql db pname
	define("EZSQL_DB_HOST", "localhost");*/ // <-- mysql server host
	
	/*$dbuser="content_apmm";
	$dbpassword="content";
	$dbname="content_Apm";
	$dbhost="mysql7.securedc.com";

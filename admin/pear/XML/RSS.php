...
class XML_RSS extends XML_Parser
{
     ...
     * @var array
     */
    var $itemTags = array('CREATOR','TITLE', 'LINK', 'DESCRIPTION', 'PUBDATE','COMMENT_COUNT');
    ...
    var $textinputTags = array('TITLE', 'DESCRIPTION','COMMENT_COUNT', 'NAME', 'LINK');
     ...
     * @var array
     */
    var $moduleTags = array('DC:TITLE', 'DC:CREATOR', 'DC:SUBJECT', 'DC:DESCRIPTION','DC:COMMENT_COUNT',
